        ...
        var members = {
            ...
            updateStage: function() {
                ...
                if (stage === 'customer') {
                    ...
                    || $('.tab-pane.active').attr('id') == 'wechatpay-content' || $('.tab-pane.active').attr('id') == 'przelewy24pay-content' || $('.tab-pane.active').attr('id') == 'trustly-content') {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data.error) {
                                    ...
                                    || $('.tab-pane.active').attr('id') == 'uniounpay-content' || $('.tab-pane.active').attr('id') == 'wechatpay-content' || $('.tab-pane.active').attr('id') == 'przelewy24pay-content' || $('.tab-pane.active').attr('id') == 'trustly-content') {
            ...
            initialize: function() {
                ...
                $('body').on('click', '.payment-options .nav-item', function(e) {
                    ...
                    || e.target.classList[1] == 'trustly-tab') {
