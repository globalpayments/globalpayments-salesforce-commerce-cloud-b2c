    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.error) {
                ...
                || ($('.tab-pane.active').attr('id') === 'bitPay-content') || ($('.tab-pane.active').attr('id') === 'uniounpay-content') || ($('.tab-pane.active').attr('id') === 'wechatpay-content') || ($('.tab-pane.active').attr('id') === 'przelewy24pay-content')) {
