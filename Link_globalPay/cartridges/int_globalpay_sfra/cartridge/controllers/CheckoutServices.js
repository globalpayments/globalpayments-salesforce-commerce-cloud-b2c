...
function handlePayments(req, res, next) {
    ...
    if (Object.keys(billingFormErrors).length) {
        ...
        ||paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.bancontactpay', 'globalpay', null)||paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.eps', 'globalpay', null)||paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.mybank', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.unionpay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.wechatpay', 'globalpay', null)
        || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.przelewy24pay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.trustly', 'globalpay', null);
        ...
        else if (empty(handlePaymentResult.error) &&localPayment) {
            res.json({
                renderedPaymentInstruments: renderedStoredPaymentInstrument,
                customer: accountModel,
                order: basketModel,
        ...
        else if (!empty(handlePaymentResult.authorizationResult)&&!handlePaymentResult.authorizationResult.error) {
...
server.prepend(
    ...
    function (req, res, next) {
        ...
        if (paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.paypal', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.googlepay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.applepay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.ideal', 'globalpay', null)
         || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.giropay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.alipay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.sofortpay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.bitpay', 'globalpay', null)
         || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.bancontactpay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.eps', 'globalpay', null)|| paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.mybank', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.unionpay', 'globalpay', null)
         || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.wechatpay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.przelewy24pay', 'globalpay', null) || paymentForm.paymentMethod.value === Resource.msg('paymentmethodname.trustly', 'globalpay', null)) {
