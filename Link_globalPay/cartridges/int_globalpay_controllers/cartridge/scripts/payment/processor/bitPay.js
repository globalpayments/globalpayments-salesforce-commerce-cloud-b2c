...
function Handle(args) {
    ...
    Transaction.wrap(function () {
        cart.removeExistingPaymentInstruments(globalpayconstants.bitPay.paymentTypeCode);
        cart.createPaymentInstrument(globalpayconstants.bitPay.paymentTypeCode, cart.getNonGiftCertificateAmount());
    });
...
/**
 * Authorizes a payment using bitPay. The payment is authorized by using the ideal pay
