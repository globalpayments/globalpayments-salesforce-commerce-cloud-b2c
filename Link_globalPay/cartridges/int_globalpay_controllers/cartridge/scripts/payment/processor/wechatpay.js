...
/**
 * This is where additional wechat integration would go.
...
function Handle(args) {
    ...
    Transaction.wrap(function () {
        cart.removeExistingPaymentInstruments(globalpayconstants.weChatPay.paymentTypeCode);
        cart.createPaymentInstrument(globalpayconstants.weChatPay.paymentTypeCode, cart.getNonGiftCertificateAmount());
    });
...
/**
 * Authorizes a payment using wechatPay. The payment is authorized by using the wechat pay
