...
function Handle(args) {
    ...
    Transaction.wrap(function () {
        cart.removeExistingPaymentInstruments(globalpayconstants.banContactPay.paymentTypeCode);
        cart.createPaymentInstrument(globalpayconstants.banContactPay.paymentTypeCode, cart.getNonGiftCertificateAmount());
    });
...
/**
 * Authorizes a payment using banContactPay. The payment is authorized by using the ideal pay
