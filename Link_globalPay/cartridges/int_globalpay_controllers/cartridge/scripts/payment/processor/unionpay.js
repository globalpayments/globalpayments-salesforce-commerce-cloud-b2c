...
/**
 * This is where additional unionPay integration would go.
...
function Handle(args) {
    ...
    Transaction.wrap(function () {
        cart.removeExistingPaymentInstruments(globalpayconstants.unionPay.paymentTypeCode);
        cart.createPaymentInstrument(globalpayconstants.unionPay.paymentTypeCode, cart.getNonGiftCertificateAmount());
    });
...
/**
 * Authorizes a payment using unionPay. The payment is authorized by using the union pay
...
function Authorize(args) {
    ...
    var lpmData = {
        ...
        payment_method: {
            ...
            apm: {
                provider: globalpayconstants.unionPay.provider
            }
        },
        notifications: {
