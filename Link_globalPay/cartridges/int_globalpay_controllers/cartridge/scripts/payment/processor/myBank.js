...
function Handle(args) {
    ...
    Transaction.wrap(function () {
        cart.removeExistingPaymentInstruments(globalpayconstants.myBankPay.paymentTypeCode);
        cart.createPaymentInstrument(globalpayconstants.myBankPay.paymentTypeCode, cart.getNonGiftCertificateAmount());
    });
...
/**
 * Authorizes a payment using myBankPay. The payment is authorized by using the ideal pay
...
function Authorize(args) {
    ...
    var lpmData = {
        ...
        payment_method: {
            ...
            apm: {
                provider: globalpayconstants.myBankPay.provider
            }
        },
        notifications: {
