...
/**
 * This is where additional aliPay integration would go.
...
function Handle(args) {
    ...
    Transaction.wrap(function () {
        cart.removeExistingPaymentInstruments(globalpayconstants.aliPay.paymentTypeCode);
        cart.createPaymentInstrument(globalpayconstants.aliPay.paymentTypeCode, cart.getNonGiftCertificateAmount());
    });
...
/**
 * Authorizes a payment using aliPay. The payment is authorized by using the aliPay
...
function Authorize(args) {
    ...
    var lpmData = {
        account_name: globalpayconstants.aliPay.account_name,
